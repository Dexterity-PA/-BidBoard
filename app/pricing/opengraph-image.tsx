  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Page title */}
        <div style={{ display: "flex", flexDirection: "column", fontSize: 80, fontWeight: 700, color: "#FFFFFF", letterSpacing: "-0.03em", lineHeight: 1.05, marginBottom: 32 }}>
          <div style={{ display: "flex" }}>Simple pricing.</div>
